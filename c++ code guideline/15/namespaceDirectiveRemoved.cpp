...
int main(int argc, char const *argv[])
{
    ...
    auto schoolDayInSec = 2 * schoolWay + 6 * schoolHoue + 4 * shortBreak + longBreak + homework;
    ...
    std::cout << "School day in milliseconds: " << schoolDayInMilli.count() << std::endl;
